...
\tagline{Industrial Engineer | Computer Sciences Engineer}
\photo{4cm}{images/cristian-ramon-cortes}
\socialinfo{
    \begin{keywords}
        ...
        \keywordsentry{\locationSymbol}{\textbf{Address:} Carrer l'Hort de la Vila, 30-34, baixos 2. 08017 Barcelona}
    \end{keywords}
}
...
\begin{document}
	...
	\input{sections/5_misc}
	\input{sections/6_experience}
